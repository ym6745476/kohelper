 ...
 */
public class KoSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = KoSwipeRefreshLayout.class.getSimpleName();
    ...
    KoSwipeCircleImageView mCircleView;
     ...
     * @param context
     */
    public KoSwipeRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public KoSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        mCircleView = new KoSwipeCircleImageView(getContext(), CIRCLE_BG_LIGHT);
    ...
    public interface OnChildScrollUpCallback {
        ...
        boolean canChildScrollUp(@NonNull KoSwipeRefreshLayout parent, @Nullable View child);
    }

    public class KoSwipeCircleImageView extends AppCompatImageView {
        ...
        KoSwipeCircleImageView(Context context, int color) {
            super(context);
            ...
            if (elevationSupported()) {
                ...
                OvalShape oval = new KoSwipeCircleImageView.OvalShadow(mShadowRadius);
        ...
        private class OvalShadow extends OvalShape {
            ...
            public void draw(Canvas canvas, Paint paint) {
                final int viewWidth = KoSwipeCircleImageView.this.getWidth();
                final int viewHeight = KoSwipeCircleImageView.this.getHeight();
